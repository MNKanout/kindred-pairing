...
const translations = {
  NO: {
    ...
    // Education Page
    'education.title': 'Ekteskapsutdanning',
    'education.subtitle': 'Bygg grunnlaget for et vellykket islamsk ekteskap gjennom omfattende utdanning og veiledning.',
    'education.description': 'Ekteskap er en av de viktigste beslutningene i livet. Vårt utdanningsprogram gir deg kunnskapen og verktøyene som trengs for å ta informerte valg og bygge et lykkelig, islamsk familieliv. Lær om plikter, forventninger, partnervalg og konfliktløsning gjennom vår omfattende læringsplan.',
    'education.topics.partner.title': 'Partnervalg',
    'education.topics.partner.description': 'Lær de viktige kriteriene og islamske prinsippene for å velge riktig livsledsager.',
    'education.topics.conflict.title': 'Konfliktløsning',
    'education.topics.conflict.description': 'Utvikle ferdigheter for å håndtere uenigheter og opprettholde harmoni i forholdet ditt.',
    'education.topics.family.title': 'Familieplikter',
    'education.topics.family.description': 'Forstå rettighetene og ansvaret til hvert familiemedlem i islam.',
    'education.topics.expectations.title': 'Ekteskapsforventninger',
    'education.topics.expectations.description': 'Sett realistiske forventninger og forbered deg på reisen til ekteskapelig liv.',
    'education.features.title': 'Programfunksjoner',
    'education.features.learn.title': 'Hva du vil lære:',
    'education.features.learn.principles': 'Islamske prinsipper for ekteskap',
    'education.features.learn.communication': 'Kommunikasjonsferdigheter for par',
    'education.features.learn.financial': 'Økonomisk planlegging og ansvar',
    'education.features.learn.intimacy': 'Bygge emosjonell intimitet',
    'education.features.learn.children': 'Oppdra barn i islam',
    'education.features.format.title': 'Programformat:',
    'education.features.format.workshops': 'Interaktive verksteder',
    'education.features.format.discussions': 'Gruppediskusjoner',
    'education.features.format.sessions': 'En-til-en-økter',
    'education.features.format.resources': 'Online ressurser og materialer',
    'education.features.format.community': 'Pågående støttefellesskap',
    'education.cta': 'Meld deg på utdanningsprogrammet',
    'education.backHome': 'Tilbake til hjemmeside',
  ...
  EN: {
    ...
    // Education Page
    'education.title': 'Marriage Education',
    'education.subtitle': 'Build the foundation for a successful Islamic marriage through comprehensive education and guidance.',
    'education.description': 'Marriage is one of the most important decisions in life. Our education program provides you with the knowledge and tools needed to make informed choices and build a happy, Islamic family life. Learn about duties, expectations, partner selection, and conflict resolution through our comprehensive curriculum.',
    'education.topics.partner.title': 'Partner Selection',
    'education.topics.partner.description': 'Learn the important criteria and Islamic principles for choosing the right life partner.',
    'education.topics.conflict.title': 'Conflict Resolution',
    'education.topics.conflict.description': 'Develop skills to handle disagreements and maintain harmony in your relationship.',
    'education.topics.family.title': 'Family Duties',
    'education.topics.family.description': 'Understand the rights and responsibilities of each family member in Islam.',
    'education.topics.expectations.title': 'Marriage Expectations',
    'education.topics.expectations.description': 'Set realistic expectations and prepare for the journey of married life.',
    'education.features.title': 'Program Features',
    'education.features.learn.title': 'What You\'ll Learn:',
    'education.features.learn.principles': 'Islamic principles of marriage',
    'education.features.learn.communication': 'Communication skills for couples',
    'education.features.learn.financial': 'Financial planning and responsibilities',
    'education.features.learn.intimacy': 'Building emotional intimacy',
    'education.features.learn.children': 'Raising children in Islam',
    'education.features.format.title': 'Program Format:',
    'education.features.format.workshops': 'Interactive workshops',
    'education.features.format.discussions': 'Group discussions',
    'education.features.format.sessions': 'One-on-one sessions',
    'education.features.format.resources': 'Online resources and materials',
    'education.features.format.community': 'Ongoing support community',
    'education.cta': 'Enroll in Education Program',
    'education.backHome': 'Back to Home',
  ...
  AR: {
    ...
    // Education Page
    'education.title': 'التعليم الزواجي',
    'education.subtitle': 'بناء الأساس لزواج إسلامي ناجح من خلال التعليم والإرشاد الشامل.',
    'education.description': 'الزواج هو واحد من أهم القرارات في الحياة. برنامج التعليم الخاص بنا يوفر لك المعرفة والأدوات اللازمة لاتخاذ خيارات مدروسة وبناء حياة أسرية إسلامية سعيدة. تعلم عن الواجبات والتوقعات واختيار الشريك وحل النزاعات من خلال منهجنا الشامل.',
    'education.topics.partner.title': 'اختيار الشريك',
    'education.topics.partner.description': 'تعلم المعايير المهمة والمبادئ الإسلامية لاختيار شريك الحياة المناسب.',
    'education.topics.conflict.title': 'حل النزاعات',
    'education.topics.conflict.description': 'تطوير مهارات للتعامل مع الخلافات والحفاظ على الانسجام في علاقتك.',
    'education.topics.family.title': 'واجبات الأسرة',
    'education.topics.family.description': 'فهم حقوق ومسؤوليات كل فرد من أفراد الأسرة في الإسلام.',
    'education.topics.expectations.title': 'توقعات الزواج',
    'education.topics.expectations.description': 'وضع توقعات واقعية والاستعداد لرحلة الحياة الزوجية.',
    'education.features.title': 'ميزات البرنامج',
    'education.features.learn.title': 'ما ستتعلمه:',
    'education.features.learn.principles': 'المبادئ الإسلامية للزواج',
    'education.features.learn.communication': 'مهارات التواصل للأزواج',
    'education.features.learn.financial': 'التخطيط المالي والمسؤوليات',
    'education.features.learn.intimacy': 'بناء الألفة العاطفية',
    'education.features.learn.children': 'تربية الأطفال في الإسلام',
    'education.features.format.title': 'شكل البرنامج:',
    'education.features.format.workshops': 'ورش عمل تفاعلية',
    'education.features.format.discussions': 'مناقشات جماعية',
    'education.features.format.sessions': 'جلسات فردية',
    'education.features.format.resources': 'موارد ومواد عبر الإنترنت',
    'education.features.format.community': 'مجتمع دعم مستمر',
    'education.cta': 'التسجيل في برنامج التعليم',
    'education.backHome': 'العودة للرئيسية',
